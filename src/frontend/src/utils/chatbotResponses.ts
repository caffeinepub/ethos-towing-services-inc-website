...
const responses: Record<string, ChatResponse> = {
  greeting: {
    text: "Hello! I'm Winchy, your Ethos Towing & Recovery assistant. I'm here to help you with any questions about our towing and roadside assistance services. How can I assist you today?",
    suggestions: ["What services do you offer?", "What's your service area?", "Tell me about ETR Everyday"]
  },
  services: {
    text: "We offer comprehensive towing services including:\n\n• Emergency Towing - 24/7 rapid response\n• Long-Distance Towing - Entire California state\n• Roadside Assistance - Jump starts, tire changes, lockouts\n• Vehicle Recovery & Jump Start - Accident recovery, off-road extraction, and battery jump starts\n• Flatbed Towing - Safe transport for luxury and specialty vehicles\n• Motorcycle Towing - Specialized equipment for bikes\n\nWe also offer ETR Everyday membership for $110/year with exclusive benefits!\n\nWhich service would you like to know more about?",
    suggestions: ["Tell me about emergency towing", "What about ETR Everyday?", "Service area coverage"]
  },
  membership: {
    text: "ETR Everyday (Ethos Towing & Recovery Everyday) is our exclusive membership program for just $110 per year!\n\nMembership includes:\n• 24/7 roadside assistance\n• Mobile battery service\n• Flat tire service\n• Emergency fuel delivery\n• Lockout services\n• Member discounts on everyday purchases\n• Expert automotive advice\n\nCall us at 559-944-8178 to sign up today!",
    suggestions: ["What services do you offer?", "How can I contact you?", "Service area"]
  },
  emergency: {
    ...
    suggestions: ["What's your service area?", "Tell me about ETR Everyday", "Contact information"]
  },
  longDistance: {
  ...
  recovery: {
    ...
    suggestions: ["Emergency towing", "ETR Everyday benefits", "Call now"]
  },
  flatbed: {
    ...
    suggestions: ["Motorcycle towing", "ETR Everyday membership", "Request service"]
  },
  motorcycle: {
    ...
    suggestions: ["Other services", "ETR Everyday benefits", "Contact information"]
  },
  serviceArea: {
    ...
    suggestions: ["What services do you offer?", "ETR Everyday membership", "Get a quote"]
  },
  availability: {
  ...
  hours: {
    ...
    suggestions: ["Emergency towing", "ETR Everyday membership", "Service area"]
  },
  default: {
    text: "I'm Winchy, and I'm here to help! I can answer questions about:\n• Our towing services (emergency, long-distance, flatbed, motorcycle)\n• Roadside assistance and vehicle recovery with jump start service\n• ETR Everyday membership ($110/year with great benefits!)\n• Service area coverage\n• Contact information and availability\n\nWhat would you like to know?",
    suggestions: ["What services do you offer?", "ETR Everyday membership", "Contact information"]
  }
};
...
const keywords: Record<string, string[]> = {
  ...
  membership: ["membership", "member", "etr everyday", "subscribe", "subscription", "plan", "join", "sign up", "$110", "110"],
